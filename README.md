...
#### Training
The speaker embeddings generated by vgg are all positive vectors, and contained many **zero** element. The uis-rnn seems abnormally deal with these data somehow, shows as below
